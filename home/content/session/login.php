        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <ul class="login__register__menu" role="tablist">
                    <li role="presentation" class="login active"><a href="#login"  style="font-size: 15pt" role="tab" data-toggle="tab">Login</a></li>
                    <li role="presentation" class="register"><a href="#register" style="font-size: 15pt" role="tab" data-toggle="tab">Register</a></li>
                </ul>
            </div>
        </div>
